        ...
        <div className="jumbotron-fluid">
          <div
            ...
            style={{
              height: '500px',
              backgroundImage:
                'url(https://images.unsplash.com/photo-1467020323552-36f7bf0e30e6?ixlib=rb-0.3.5&s=b3885f1c152f7357fa0a7393bb8f6112&auto=format&fit=crop&w=2550&q=80)'
            }}
          >
            <div
            ...
            <div
              className="col-xs-12 col-sm-5 homepage-card"
              style={{ marginTop: '5em', textAlign: 'center' }}
            >
              <a
                className="btn btn-danger margin-vertical-sm"
                href="/auth/google"
              >
                Sign in with Google
              </a>
