      ...
      <div className="container-fluid">
          <div className="row hero-image">
            ...
            <div className="mobile-card text-align-center">
              ...
              <a className="btn-yellow sign-in-button margin-vertical-md" href="#">
            ...
            >
              ...
              <br />
              <a className="facebook sign-in-button margin-vertical-md" href="#">
                <div className="content-wrapper">
                <div className="logo-wrapper">
              ...
              <br />
              <a className="btn-green sign-in-button margin-vertical-md" href="#">
                <div className="content-wrapper">
                <div className="logo-wrapper">
