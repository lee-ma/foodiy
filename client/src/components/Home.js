      ...
      <div className="container-fluid">
          <div className="row hero-image">
            ...
            <div className="mobile-card text-align-center">
              ...
              <a class="btn-yellow sign-in-button margin-vertical-md" href="#">
            ...
            >
              ...
              <br />
              <a class="btn-green sign-in-button margin-vertical-md" href="#">
                <div class="content-wrapper">
                <div class="logo-wrapper">
              ...
              <a class="btn-yellow sign-in-button" href="#">
                <div class="content-wrapper">
                <div class="logo-wrapper">
